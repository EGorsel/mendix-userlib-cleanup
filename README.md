...
## 📖 1. How to Use
   ...
   ### 📥 1.1. Quick Start
   1. **Setup**:
      - Download the [latest release](https://github.com/EGorsel/mendix-userlib-cleanup/releases) and
      - place `mx--cleanuserlib.exe` in your **Mendix Project Root** (the folder containing your `.mpr` file).
